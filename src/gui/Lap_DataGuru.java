 ...
 * @author User
 */
public class Lap_DataGuru extends javax.swing.JFrame {
JasperReport jasperReport1;
    ...
    private void initComponents() {
        ...
        setTitle("Cetak Laporan Data Tahun Ajaran");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            File file = new File("src/laporan/DataGuru.jrxml");
            jasperDesign1 = JRXmlLoader.load(file);
             param.put("nama",Beranda.user.getText());
            param.put("nip",Beranda.nip.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lap_DataGuru.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
