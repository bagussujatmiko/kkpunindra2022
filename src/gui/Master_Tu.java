...
public class Master_Tu extends javax.swing.JFrame {
 private DefaultTableModel model;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 20, 230, 41));
        ...
        cbnJabatan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Jabatan -", "admin" }));
        getContentPane().add(cbnJabatan, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 240, 100, 30));

        GsExit.setBackground(new java.awt.Color(153, 255, 255));
        ...
        getContentPane().add(GsExit, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 0, 60, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Master_Tu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
